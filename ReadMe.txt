========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ULAHostV2
========================================================================


AppWizard が生成した ULAHostV2 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ULAHostV2 を構成している各ファイルの概要説明が含まれています。
...
ULAHostV2.h
    ...
    みます） をインクルードし、また CULAHostV2App アプリケーションクラスを宣
    言します。

ULAHostV2.cpp
    このファイルは CULAHostV2App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ULAHostV2.ico
    ...
    ルです。このアイコンはリソース ファイル ULAHostV2.rc によってインクルード
    されます。
...
ULAHostV2Dlg.h, ULAHostV2Dlg.cpp - ダイアログ
    これらのファイルは CULAHostV2Dlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ULAHostV2.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ULAHostV2.pch 
